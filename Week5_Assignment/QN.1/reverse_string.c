...
#define __pyx_n_u_reverse_string __pyx_string_tab[19]
...
#define __pyx_kp_b_iso88591_1A_axq_U_1_Qe1ARr_2Q_2U_1 __pyx_string_tab[25]
...
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "reverse_string", 0) < (0)) __PYX_ERR(0, 1, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 1; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("reverse_string", 1, 1, 1, i); __PYX_ERR(0, 1, __pyx_L3_error) }
      }
  ...
  __Pyx_RaiseArgtupleInvalid("reverse_string", 1, 1, 1, __pyx_nargs); __PYX_ERR(0, 1, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_s), (&PyUnicode_Type), 1, "s", 1))) __PYX_ERR(0, 1, __pyx_L1_error)
...
*/
  ...
  __pyx_t_1 = __Pyx_PyUnicode_GET_LENGTH(__pyx_v_s); if (unlikely(__pyx_t_1 == ((Py_ssize_t)-1))) __PYX_ERR(0, 6, __pyx_L1_error)
  __pyx_v_n = __pyx_t_1;

  /* "reverse_string.pyx":8
 *     cdef Py_ssize_t n = len(s)
 *     cdef Py_ssize_t i
 *     cdef list chars = [None] * n             # <<<<<<<<<<<<<<
 *     for i in range(n):
 *         chars[i] = s[n - 1 - i]
*/
  __pyx_t_2 = PyList_New(1 * ((__pyx_v_n<0) ? 0:__pyx_v_n)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  { Py_ssize_t __pyx_temp;
    for (__pyx_temp=0; __pyx_temp < __pyx_v_n; __pyx_temp++) {
      __Pyx_INCREF(Py_None);
      __Pyx_GIVEREF(Py_None);
      if (__Pyx_PyList_SET_ITEM(__pyx_t_2, __pyx_temp, Py_None) != (0)) __PYX_ERR(0, 8, __pyx_L1_error);
    }
  }
  __pyx_v_chars = ((PyObject*)__pyx_t_2);
  __pyx_t_2 = 0;

  /* "reverse_string.pyx":9
 *     cdef Py_ssize_t i
 *     cdef list chars = [None] * n
 *     for i in range(n):             # <<<<<<<<<<<<<<
 *         chars[i] = s[n - 1 - i]
...
*/
  ...
  for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
    ...
    /* "reverse_string.pyx":10
 *     cdef list chars = [None] * n
 *     for i in range(n):
 *         chars[i] = s[n - 1 - i]             # <<<<<<<<<<<<<<
 *     return ''.join(chars)
*/
    __pyx_t_5 = ((__pyx_v_n - 1) - __pyx_v_i);
    __pyx_t_6 = __Pyx_GetItemInt_Unicode(__pyx_v_s, __pyx_t_5, Py_ssize_t, 1, PyLong_FromSsize_t, 0, 1, 1, 1, __Pyx_ReferenceSharing_FunctionArgument); if (unlikely(__pyx_t_6 == (Py_UCS4)-1)) __PYX_ERR(0, 10, __pyx_L1_error)
    __pyx_t_2 = __Pyx_PyUnicode_FromOrdinal(__pyx_t_6); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 10, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    if (unlikely((__Pyx_SetItemInt(__pyx_v_chars, __pyx_v_i, __pyx_t_2, Py_ssize_t, 1, PyLong_FromSsize_t, 1, 1, 1, 1, __Pyx_ReferenceSharing_OwnStrongReference) < 0))) __PYX_ERR(0, 10, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  }

  /* "reverse_string.pyx":11
 *     for i in range(n):
 *         chars[i] = s[n - 1 - i]
 *     return ''.join(chars)             # <<<<<<<<<<<<<<
*/
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_2 = PyUnicode_Join(__pyx_mstate_global->__pyx_kp_u_, __pyx_v_chars); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_r = __pyx_t_2;
  __pyx_t_2 = 0;
  goto __pyx_L0;
 ...
 *     Reverse a Python unicode string and return the result.
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_14reverse_string_1reverse_string, 0, __pyx_mstate_global->__pyx_n_u_reverse_string, NULL, __pyx_mstate_global->__pyx_n_u_reverse_string, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_reverse_string, __pyx_t_2) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 8; } index[] = {{0},{179},{1},{8},{18},{20},{18},{5},{18},{8},{1},{13},{5},{8},{10},{1},{8},{3},{12},{14},{1},{12},{10},{8},{6},{65}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 